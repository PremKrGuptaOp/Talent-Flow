...
export const Sidebar: React.FC = () => {
  ...
  return (
    <ShadcnSidebar
      variant="inset"
      className="border-r border-gray-600 bg-gradient-to-b from-blue-900 to-purple-900"
    >
      <SidebarHeader
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-gray-300">Recruiting Suite</p>
          </div>
        </div>
      </SidebarHeader>
      ...
      >
        <div className="text-xs text-gray-300">
          ...
          <p className="mt-1">© 2025 RecruitTech</p>
        </div>
      </div>
    </ShadcnSidebar>
  );
