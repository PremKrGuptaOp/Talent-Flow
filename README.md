...
- ✅ **Kanban Board**: Drag-and-drop stage management with visual pipeline and improved UI
  - Enhanced drag-and-drop responsiveness with optimized sensor configuration
  - Improved visual feedback during drag operations
  - Dedicated sidebar navigation for quick access
...
1. **Clone the repository**
   ...
   ```bash
   git clone <https://github.com/PremKrGuptaOp/talentflow.git>
   cd talentflow
   ```
...
```
Created with by Prem Kumar Gupta.
